        ...
        <div class="row text-white">
            ...
            <div class="col-xl-2 col-sm-6 col-md-6 col-lg-6">
                <div class="footer_text">
                    ...
                    <ul class="footer_link">
                        @foreach (Menu::getByName('Footer Menu  One') as $menu)
                            <li><a href="{{ $menu['link'] }}"><i class="far fa-chevron-double-right"></i>
                                    {{ $menu['label'] }}</a></li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="col-xl-2 col-sm-6 col-md-3 col-lg-3">
                <div class="footer_text">
                    <h3>Helpful Links</h3>
                    <ul class="footer_link">
                        @foreach (Menu::getByName('Footer Menu Two') as $menu)
                            <li><a href="{{ $menu['link'] }}"><i class="far fa-chevron-double-right"></i>
                                    {{ $menu['label'] }}</a></li>
                        @endforeach
                    </ul>
            ...
            <div class="col-xl-2 col-sm-6 col-md-3 col-lg-3">
                <div class="footer_text">
                    <h3>Information</h3>
                    <ul class="footer_link">
                        @foreach (Menu::getByName('Footer Menu Three') as $menu)
                            <li><a href="{{ $menu['link'] }}"><i class="far fa-chevron-double-right"></i>
                                    {{ $menu['label'] }}</a></li>
                        @endforeach
                    </ul>
