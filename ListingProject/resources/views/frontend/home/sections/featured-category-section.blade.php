            ...
            <div class="row">
                <div class="col-xl-5 m-auto">
                    <div class="wsus__heading_area">
                        <h2>{{ @$sectionTitles->our_categories_title  }}</h2>
                        <p>{{ @$sectionTitles->our_categories_sub_title }}</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <a href="{{ route('listings', ['category' => $category->slug]) }}" class="wsus__category_single">
                            <div class="wsus__category_img">
                                <img src="{{ asset($category->background_image) }}" alt="{{ $category->name }}"
                            ...
                            <div class="wsus__category_text">
                                <div class="wsus__category_text_center">
                                    ...
                                    <p>{{ $category->name }}</p>
                                    <span class="green">{{ $category->listings_count }}</span>
                                </div>
                            </div>
                        </a>
                    </div>
