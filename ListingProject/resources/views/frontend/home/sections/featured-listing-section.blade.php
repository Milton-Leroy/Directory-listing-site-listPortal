        ...
        <div class="row">
            <div class="col-xl-5 m-auto">
                <div class="wsus__heading_area">
                    <h2>{{ @$sectionTitles->our_featured_listing_title  }}</h2>
                    <p>{{ @$sectionTitles->our_featured_listing_sub_title  }}
            </div>
        </div>
    </div>
    <div class="container">
            ...
            @foreach (@$featuredListings as $listing)
                <div class="col-xl-4 col-sm-6">
                    <div class="wsus__featured_single">
                        ...
                        <a class="map" onclick="showListingAlert('{{ $listing->id }}')" data-bs-toggle="modal"
