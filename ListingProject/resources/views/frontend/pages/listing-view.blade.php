                        ...
                        <div class="listing_det_header">
                            ...
                            <div class="listing_det_header_text">
                                ...
                                <p class="rating">
                                    ...
                                    <span>({{ count($listing->reviews) }} reviews)</span>
                                </p>
                                <ul>
                                    ...
                                    @elseif($openStatus === 'closed')
                                        <li><a href="javascript:;">Closed</a></li>
                                    @endif
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="blog_single_input">
                                                <textarea cols="3" rows="5" name="review" placeholder="Comment"></textarea>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-listing-content listing_det_side_contact" style="box-shadow: none">
                        ...
                        <form type="text" action="{{ route('submit-claim') }}" method="post" placeholder="Name*">
                            @csrf
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-listing-content listing_det_side_contact" style="box-shadow: none">
                        ...
                        <form type="text" action="" method="post" class="message-form">
                            @csrf
                            <input type="hidden" value="{{ $listing->user_id }}" name="receiver_id">
                            <input type="hidden" value="{{ $listing->id }}" name="listing_id">
                            <textarea rows="5" placeholder="Message*" class="" name="message"></textarea>
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('.send-btn').html(` <span class="spinner-border spinner-border-sm text-light" role="status" aria-hidden="true"></span>
                                            <span class="text-light">Sending...</span>`);
