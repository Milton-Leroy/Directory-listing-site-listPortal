                            ...
                            <div class="wsus__pro_check">
                                ...
                                @foreach ($amenities as $amenity)
                                    <div class="form-check">
                                        <input @checked(in_array($amenity->slug, (request()->has('amenity') && is_array(request()->amenity)) ? request()->amenity : []))
                                                class="form-check-input" type="checkbox"
                                            value="{{ $amenity->slug }}" id="flexCheckIndeterminate-{{ $amenity->id }}"
                                            name="amenity[]">
                        ...
                        @foreach ($listings as $listing)
                            <div class="col-xl-4 col-sm-6">
                                <div class="wsus__featured_single">
                                    ...
                                    <a class="map" onclick="showListingAlert('{{ $listing->id }}')"
                                    ...
                                    <div class="wsus__featured_single_text">
                                        ...
                                        <a
                                            href="{{ route('listing.show', $listing->slug) }}">{{ truncate($listing->title, 23) }}</a>
