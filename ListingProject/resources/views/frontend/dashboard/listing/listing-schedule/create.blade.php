                ...
                <div class="col-lg-9">
                    <div class="dashboard_content">
                        <div class="my_listing">
                            <a href="{{ route('user.listing-schedule.index',$listingId) }}" class="btn btn-sm btn-primary"><i
                                class="fas fa-chevron-left"></i></a>
                            <h4>Create Schedule</h4>
                            <form action="{{ route('user.listing-schedule.store', request()->listing_id) }}" method="post">
                                @csrf
