                                                ...
                                                @if ($subscription?->package)
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="package_right">
                                                                @if ($subscription->package->price == 0)
                                                                    free
                                                                @else
                                                                    {{ currencyPosition($subscription->package->price) }}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="package_right">
                                                                @if ($subscription->package->number_of_listing === -1)
                                                                    Unlimited
                                                                @else
                                                                    {{ $subscription->package->number_of_listing }}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="package_right">
                                                                @if ($subscription->package->number_of_amenities === -1)
                                                                    Unlimited
                                                                @else
                                                                    {{ $subscription->package->number_of_amenities }}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="active_left">Maximum Photos</td>
                                                            <td class="package_right">
                                                                @if ($subscription->package->number_of_photos === -1)
                                                                    Unlimited
                                                                @else
                                                                    {{ $subscription->package->number_of_photos }}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="active_left">Maximum Videos</td>
                                                            <td class="package_right">
                                                                @if ($subscription->package->number_of_video === -1)
                                                                    Unlimited
                                                                @else
                                                                    {{ $subscription->package->number_of_video }}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="package_right">
                                                                @if ($subscription->package->number_of_featured_listing === -1)
                                                                    Unlimited
                                                                @else
                                                                    {{ $subscription->package->number_of_featured_listing }}
                                                                @endif
