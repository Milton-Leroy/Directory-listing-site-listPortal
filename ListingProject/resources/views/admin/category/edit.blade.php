                            ...
                            <form action="{{ route('admin.category.update',$category->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <input type="hidden" name="old_icon" id="image-upload" value="{{ $category->image_icon }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="image-preview-2" class="image-preview">
                                                ...
                                                <input type="hidden" name="old_background" id="image-upload-2" value="{{ $category->background_image }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="" class="form-control">
                                        ...
                                        <option  @selected($category->staus === 1) value="0">Inactive</option>
                                    </select>
                                </div>
